...
def get_ny_time(utc_time: datetime) -> datetime:
    return _ensure_utc(utc_time).astimezone(NY)
...
def session_bars_for_day(bars: list[Bar], utc_time: datetime) -> list[Bar]:
    """M1 bars from current NY calendar day after 9:30 open."""
