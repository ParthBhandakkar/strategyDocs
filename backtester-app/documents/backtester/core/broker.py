...
from . import Bar, Signal, Trade, Position, Direction
...
class SimulatedBroker:
    ...
    def execute_signal(
        ...
        dollars_per_pip = self.pip_value_per_lot(sym)
    ...
    def update_positions(
        ...
        dollars_per_pip = self.pip_value_per_lot(symbol)
