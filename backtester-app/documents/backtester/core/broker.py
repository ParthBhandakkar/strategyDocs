...
def pip_value_per_lot_usd(symbol: str, price: float | None = None) -> float:
...
class SimulatedBroker:
    ...
    def set_pip_value(self, symbol: str):
        ...
        self.pip_value_per_lot = pip_value_per_lot_usd(symbol)
    ...
    def execute_signal(
        ...
        self.pip_value_per_lot = pip_value_per_lot_usd(signal.symbol, signal.entry_price)
