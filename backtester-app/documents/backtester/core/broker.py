...
Symbol-aware lot sizing for comparable risk across instruments.
"""
...
class SimulatedBroker:
    ...
    def __init__(
        ...
        self.symbol_spec = get_symbol_spec("EURUSD")
        self._next_trade_id = 1
        self.open_positions: list[Position] = []
        self.closed_trades: list[Trade] = []

    def set_pip_value(self, symbol: str) -> None:
        self.symbol_spec = get_symbol_spec(symbol)
        self.pip_value = self.symbol_spec.pip_value
    ...
    def execute_signal(
        ...
        lot_size = risk_amount / (pip_distance * self.symbol_spec.dollar_per_pip_per_lot)
        ...
        trade = Trade(
            ...
            metadata={
                **signal.metadata,
                ...
                "dollar_per_pip_per_lot": self.symbol_spec.dollar_per_pip_per_lot,
