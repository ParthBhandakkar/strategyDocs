...
def dollars_per_pip_per_lot(symbol: str, price: float) -> float:
...
class SimulatedBroker:
    ...
    def execute_signal(
        ...
        pip_dollar = dollars_per_pip_per_lot(signal.symbol, signal.entry_price)
        lot_size = risk_amount / (pip_distance * pip_dollar)
