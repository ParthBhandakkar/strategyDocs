...
class Trade:
    ...
    def close(
        ...
        """Close the trade and calculate PnL in USD."""
        ...
        self.pnl = (self.pnl_pips * pip_value_per_lot * lot_size) if pip_value > 0 else 0.0
...
class BacktestResult:
    ...
    def compute_stats(self):
        ...
        self.total_pnl = sum(t.metadata.get("pnl_usd", t.pnl) for t in self.trades)
        self.avg_rr = round(
