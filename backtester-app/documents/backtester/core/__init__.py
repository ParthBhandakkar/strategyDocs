...
class Trade:
    ...
    def close(
        ...
        gross_usd = self.pnl_pips * pip_usd_per_lot * lot_size
        self.pnl = round(gross_usd - commission, 2)
        self.metadata["pnl_usd"] = self.pnl
        self.metadata.setdefault("lot_size", lot_size)
        self.metadata.setdefault("commission", commission)
