...
class MultiTimeframeDataFeed:
    ...
    when base-timeframe bars close.
    """
    ...
    def __iter__(self):
        ...
        for base_bar in base_bars:
            bar_close = base_bar.time + base_duration
            self._current_time = bar_close
            ...
            for sym in [self.symbol] + self.extra_symbols:
                for tf in self.timeframes:
                    ...
                    while idx < len(tf_bars):
                        ...
                        candidate_close = candidate.time + tf_duration
                        if candidate_close > self._current_time:
                            break
