...
class BacktestEngine:
    """Event-driven backtesting engine using injectable local data client."""
    ...
    def run(self) -> BacktestResult:
        ...
        for event in self.data_feed:
            ...
            if base_bar:
                ...
                for trade in closed_trades:
                    self.portfolio.on_trade_closed(trade, self.broker)
            ...
            for signal in signals or []:
                if not self.broker.has_open_position(signal.strategy_id):
                    ...
                    if fill:
                        self.portfolio.on_commission(fill.commission)
        ...
        if last_bar:
            for pos in list(self.broker.open_positions):
                ...
                self.portfolio.on_trade_closed(pos.trade, self.broker)
