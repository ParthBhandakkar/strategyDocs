    ...
    def run(self) -> BacktestResult:
        ...
        for event in self.data_feed:
            ...
            if base_bar:
                ...
                for trade in closed_trades:
                    ...
                    self.portfolio.on_trade_closed(trade, lot_size=lot_size, pip_value=self.broker.pip_value)
        ...
        if last_bar:
            for pos in list(self.broker.open_positions):
                ...
                self.portfolio.on_trade_closed(pos.trade, lot_size=lot_size, pip_value=self.broker.pip_value)
