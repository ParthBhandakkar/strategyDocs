        ...
        for event in self.data_feed:
            ...
            if base_bar:
                ...
                for trade in closed_trades:
                    self.portfolio.on_trade_closed(trade, self.broker.get_lot_size(trade.id))
        ...
        if last_bar:
            for pos in list(self.broker.open_positions):
                pos.trade.close(
                    ...
                    commission=self.broker.commission_for_lot(pos.lot_size),
                )
                self.portfolio.on_trade_closed(pos.trade, pos.lot_size)
